...
//#region src/plugins/delegate-permissions/error-codes.ts
const DELEGATE_PERMISSIONS_ERROR_CODES = defineErrorCodes({
	...
	RENEWAL_IDENTITY_MISMATCH: "Renewal CSR identity does not match original credential"
});
//#endregion
