...
declare function createSelfSignedCaPem(privateJwk: Record<string, unknown>, commonName: string): Promise<{
  rootPem: string;
  ski: string;
  publicJwk: Record<string, unknown>;
}>;
/** Build (or rebuild) a self-signed Platform Root CA PEM from an Ed25519 private JWK. */
declare function createPlatformRootPem(privateJwk: Record<string, unknown>, commonName?: string): Promise<{
  rootPem: string;
  ski: string;
  publicJwk: Record<string, unknown>;
}>;
...
declare function generateEphemeralPlatformCa(commonName?: string): Promise<PlatformCaMaterial>;
