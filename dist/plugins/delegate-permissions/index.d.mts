...
import { DelegatePermissionsOptions, DpActionRow, DpCatalogMetaRow, DpCredentialRow, DpEnrollInviteRow, DpEnrollKind, DpEnrollRequestRow, DpEntityRow, DpNameOccupancyRow, DpPrincipalGrantRow, DpProfileRow, DpRevocationReason, DpScopeDimensionRow, DpSessionGrantRow, DpUserCredentialBindRow } from "./types.mjs";
...
declare const delegatePermissions: (options?: DelegatePermissionsOptions) => {
    ...
    dpProfile: {
      fields: {
        ...
        permissions: {
          ...
          required: true;
          transform: {
            input(value: _$_better_auth_core_db0.DBPrimitive): string | number | boolean | Date | Record<string, unknown> | null | undefined;
            output(value: _$_better_auth_core_db0.DBPrimitive): _$_better_auth_core_db0.DBPrimitive;
          };
        };
        catalogGeneration: {
          type: "number";
  ...
  endpoints: {
    dpPlatformRoot: _$better_call0.StrictEndpoint<"/delegate-permissions/platform-root", {
      method: "GET";
      metadata: {
        openapi: {
          description: string;
    ...
    dpSeedCatalog: _$better_call0.StrictEndpoint<"/delegate-permissions/seed-catalog", {
      method: "POST";
    ...
    dpGetCatalog: _$better_call0.StrictEndpoint<"/delegate-permissions/catalog", {
      method: "GET";
    ...
    dpSetPrincipalGrant: _$better_call0.StrictEndpoint<"/delegate-permissions/principal-grant", {
      method: "POST";
      use: _$better_call0.Middleware<_$better_call0.MiddlewareOptions, (inputContext: _$better_call0.MiddlewareInputContext<_$better_call0.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
    ...
    dpIssueSessionCapabilities: _$better_call0.StrictEndpoint<"/delegate-permissions/issue-session-capabilities", {
      method: "POST";
      use: _$better_call0.Middleware<_$better_call0.MiddlewareOptions, (inputContext: _$better_call0.MiddlewareInputContext<_$better_call0.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
    ...
    dpAuthorize: _$better_call0.StrictEndpoint<"/delegate-permissions/authorize", {
      method: "POST";
      use: _$better_call0.Middleware<_$better_call0.MiddlewareOptions, (inputContext: _$better_call0.MiddlewareInputContext<_$better_call0.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
    ...
    dpAssertSubset: _$better_call0.StrictEndpoint<"/delegate-permissions/assert-subset", {
      method: "POST";
      use: _$better_call0.Middleware<_$better_call0.MiddlewareOptions, (inputContext: _$better_call0.MiddlewareInputContext<_$better_call0.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
    ...
    dpCredentialRevoke: _$better_call0.StrictEndpoint<"/delegate-permissions/credential-revoke", {
      method: "POST";
      use: _$better_call0.Middleware<_$better_call0.MiddlewareOptions, (inputContext: _$better_call0.MiddlewareInputContext<_$better_call0.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
    ...
    dpCredentialStatus: _$better_call0.StrictEndpoint<"/delegate-permissions/credential-status", {
      method: "GET";
      query: z.ZodObject<{
        ski: z.ZodString;
      }, z.core.$strip>;
    ...
    dpCredentialList: _$better_call0.StrictEndpoint<"/delegate-permissions/credential-list", {
      method: "GET";
      use: _$better_call0.Middleware<_$better_call0.MiddlewareOptions, (inputContext: _$better_call0.MiddlewareInputContext<_$better_call0.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
    ...
    dpMachineDecommission: _$better_call0.StrictEndpoint<"/delegate-permissions/machine-decommission", {
      method: "POST";
      use: _$better_call0.Middleware<_$better_call0.MiddlewareOptions, (inputContext: _$better_call0.MiddlewareInputContext<_$better_call0.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
    ...
    dpMachineRenew: _$better_call0.StrictEndpoint<"/delegate-permissions/machine-renew", {
      method: "POST";
      use: _$better_call0.Middleware<_$better_call0.MiddlewareOptions, (inputContext: _$better_call0.MiddlewareInputContext<_$better_call0.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
    ...
    dpEnrollCreate: _$better_call0.StrictEndpoint<"/delegate-permissions/enroll-create", {
      method: "POST";
      body: z.ZodObject<{
        entityId: z.ZodOptional<z.ZodString>;
    ...
    dpEnrollInviteCreate: _$better_call0.StrictEndpoint<"/delegate-permissions/enroll-invite", {
      method: "POST";
      use: _$better_call0.Middleware<_$better_call0.MiddlewareOptions, (inputContext: _$better_call0.MiddlewareInputContext<_$better_call0.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
    ...
    dpEnrollInviteGet: _$better_call0.StrictEndpoint<"/delegate-permissions/enroll-invite", {
      method: "GET";
      query: z.ZodObject<{
    ...
    dpEnrollList: _$better_call0.StrictEndpoint<"/delegate-permissions/enroll-list", {
      method: "GET";
      use: _$better_call0.Middleware<_$better_call0.MiddlewareOptions, (inputContext: _$better_call0.MiddlewareInputContext<_$better_call0.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
    ...
    dpEnrollApprove: _$better_call0.StrictEndpoint<"/delegate-permissions/enroll-approve", {
      method: "POST";
      use: _$better_call0.Middleware<_$better_call0.MiddlewareOptions, (inputContext: _$better_call0.MiddlewareInputContext<_$better_call0.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
    ...
    dpEnrollReject: _$better_call0.StrictEndpoint<"/delegate-permissions/enroll-reject", {
      method: "POST";
      use: _$better_call0.Middleware<_$better_call0.MiddlewareOptions, (inputContext: _$better_call0.MiddlewareInputContext<_$better_call0.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
    ...
    dpEnrollPull: _$better_call0.StrictEndpoint<"/delegate-permissions/enroll-pull", {
      method: "POST";
      body: z.ZodObject<{
    ...
    dpEnrollInstant: _$better_call0.StrictEndpoint<"/delegate-permissions/enroll-instant", {
      method: "POST";
      use: _$better_call0.Middleware<_$better_call0.MiddlewareOptions, (inputContext: _$better_call0.MiddlewareInputContext<_$better_call0.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
    ...
    dpEnrollMachinePermissions: _$better_call0.StrictEndpoint<"/delegate-permissions/enroll-machine-permissions", {
      method: "POST";
      use: _$better_call0.Middleware<_$better_call0.MiddlewareOptions, (inputContext: _$better_call0.MiddlewareInputContext<_$better_call0.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
    ...
    dpKickstartEntity: _$better_call0.StrictEndpoint<"/delegate-permissions/kickstart-entity", {
      method: "POST";
      use: _$better_call0.Middleware<_$better_call0.MiddlewareOptions, (inputContext: _$better_call0.MiddlewareInputContext<_$better_call0.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
    ...
    dpGetEntity: _$better_call0.StrictEndpoint<"/delegate-permissions/entity", {
      method: "GET";
      use: _$better_call0.Middleware<_$better_call0.MiddlewareOptions, (inputContext: _$better_call0.MiddlewareInputContext<_$better_call0.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
    ...
    dpIssueDelegate: _$better_call0.StrictEndpoint<"/delegate-permissions/issue-delegate", {
      method: "POST";
      use: _$better_call0.Middleware<_$better_call0.MiddlewareOptions, (inputContext: _$better_call0.MiddlewareInputContext<_$better_call0.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
    ...
    dpIssueMachine: _$better_call0.StrictEndpoint<"/delegate-permissions/issue-machine", {
      method: "POST";
      use: _$better_call0.Middleware<_$better_call0.MiddlewareOptions, (inputContext: _$better_call0.MiddlewareInputContext<_$better_call0.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
