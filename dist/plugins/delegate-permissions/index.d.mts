...
declare const delegatePermissions: (options?: DelegatePermissionsOptions) => {
  ...
  endpoints: {
    ...
    dpEnrollInviteCreate: better_call0.StrictEndpoint<"/delegate-permissions/enroll-invite", {
      method: "POST";
      use: ((inputContext: better_call0.MiddlewareInputContext<better_call0.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
    ...
    dpEnrollInviteGet: better_call0.StrictEndpoint<"/delegate-permissions/enroll-invite", {
      method: "GET";
      query: z.ZodObject<{
