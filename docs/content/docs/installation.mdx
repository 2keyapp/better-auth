...
<Steps>
  <Step>
    ...
    Better Auth is installed from GitHub, not npm. Add the core package using the **`release`** branch:
    ...
    <Callout>
      See [Install from GitHub](/docs/guides/github-installation) for the full package index (SCIM, Flutter, Dart client) and release-branch details.
    </Callout>
  </Step>
